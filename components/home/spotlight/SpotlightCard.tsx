    ...
    >
      ...
      {editing ? (
        ...
        <div key={animKey} className={animClass || ''} style={{ willChange: 'transform' }}>
          <div className="md:grid md:grid-cols-[minmax(0,1fr)_360px] md:gap-6 gap-4">
            {/* LEFT: image + details */}
            <div>
            ...
            {/* RIGHT: rating + my comment + others list */}
            <aside className="mt-4 md:mt-0">
              <div className="rounded-xl border dark:border-gray-800 bg-white/70 dark:bg-gray-900/70 p-3 md:sticky md:top-16">
                ...
                {!!(item.comments && item.comments.length) && <div className="mt-2 border-t dark:border-gray-800" />}
