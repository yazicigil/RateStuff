      ...
      return (
        <div className={className}>
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl px-3 py-1.5 border border-zinc-300/50 hover:border-zinc-300/80 transition"
          >
            {/* Plus icon */}
      ...
      <div className="flex items-center gap-3">
        ...
        {canEdit && (
          <button
            ...
            className="ml-2 rounded-lg p-2 border border-zinc-300/50 hover:border-zinc-300/80 transition"
