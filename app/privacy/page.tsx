...
export default function PrivacyPage() {
  ...
  return (
    <main className="rs-mobile-edge mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="prose prose-sm md:prose-base dark:prose-invert mt-6">
        <p>
        ...
        <p>
          ...
          veya <Link className="underline" href="/privacy#reach-us">Bize Ulaş</Link> formunu kullanabilirsiniz.
        </p>
      </div>
    </main>
  );
