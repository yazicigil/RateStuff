      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 pt-0 pb-8 sm:pb-12 -mt-4 sm:-mt-6">
        ...
        >
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <div className="inline-flex items-center gap-2 rounded-full px-2.5 py-1 border" style={{ backgroundColor: "transparent", borderColor: heroSubtle }}>
            ...
            <div className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 border" style={{ backgroundColor: "transparent", borderColor: heroSubtle }}>
